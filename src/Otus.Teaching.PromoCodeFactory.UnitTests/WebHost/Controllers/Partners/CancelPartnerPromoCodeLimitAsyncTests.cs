...
public class CancelPartnerPromoCodeLimitAsyncTests {
    ...
    public async void CancelPartnerPromoCodeLimitAsync_PartnerIsNotFound_ReturnsNotFound() {
        // Arrange
        Guid partnerId = Guid.Parse("def47943-7aaf-44a1-ae21-05aa4948b165");
        ...
        // Act
        IActionResult result = await _partnersController.CancelPartnerPromoCodeLimitAsync(partnerId);
