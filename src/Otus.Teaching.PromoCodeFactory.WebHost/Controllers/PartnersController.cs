...
public class PartnersController
    ...
    public PartnersController(IRepository<Partner> partnersRepository) => _partnersRepository = partnersRepository;
    ...
    public async Task<ActionResult<PartnerPromoCodeLimit>> GetPartnerLimitAsync(Guid id, Guid limitId) {
        ...
        PartnerPromoCodeLimitResponse response = new() {
            Id = limit.Id,
    ...
    public async Task<IActionResult> SetPartnerPromoCodeLimitAsync(Guid id, SetPartnerPromoCodeLimitRequest request) {
        ...
        PartnerPromoCodeLimit newLimit = new() {
            Limit = request.Limit,
            Partner = partner,
